...
export  default  class Topic extends Component{
    static propTypes = {
        ...
        //ExceptionsManager.js:73 Warning: Failed prop type: Topic: prop type `style` is invalid; it must be a function, usually from React.PropTypes.
        // 使用 React.ProTypes.style
    ...
    render(){
        ...
        const avatarUri = {uri : topic.speak_avatar} || require('../assets/default_avatar.png')
        return(
